...
- Exact-blend ranking finds opposing spatial camera evidence in 3,691 of 3,793
  ...
  does not anchor absolute layer or optical ownership. Retain calibrated OLAT
  RGB and masks in the shared objective; C713 and C777 remain untouched
  transfer gates.
