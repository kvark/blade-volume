...
- Exact-blend ranking finds opposing spatial camera evidence in 3,691 of 3,793
  ...
  subset and a 17,681-site append are worse. All scratch paths are removed.
  Close the 16K family and test the fixed nearest-site rule once at the
  established 64K/256 scale before any transfer object. C713 and C777 remain
