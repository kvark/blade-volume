...
- Exact-blend ranking finds opposing spatial camera evidence in 3,691 of 3,793
  ...
  7.41 points, and 153/192 tails regress. Both scratch paths are removed. Keep
  the cloud adaptive and associate tracks softly with first-surface ownership,
  guarded by complete-render support. C713 and C777 remain untouched transfer
  gates.
