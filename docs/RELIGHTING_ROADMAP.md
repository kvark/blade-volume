...
- One finite-distance visibility ray reuses that shader and its existing ray
  ...
  light still teaches the wrong material. Keep visibility opt-in until a
  bounded bounce is coupled in fitting and transport.
