...
pub const SURFACE_DETAIL: &str = include_str!("../shaders/surface_detail.wgsl");
pub const SPHERICAL_VORONOI: &str = include_str!("../shaders/spherical_voronoi.wgsl");
...
pub const RELIGHT_BLIT: &str = include_str!("../shaders/relight_blit.wgsl");
...
pub const PATH_COMPACT: &str = include_str!("../shaders/path_compact.wgsl");
...
const INCLUDES: &[(&str, &str)] = &[
    ...
    ("surface_detail.wgsl", SURFACE_DETAIL),
    ("spherical_voronoi.wgsl", SPHERICAL_VORONOI),
