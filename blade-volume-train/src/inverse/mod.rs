...
//! 3. [`refine`] moves those particles to one shared multi-view surface.
//! 4. [`decompose`] splits what was observed into a material and a light.
//! 5. [`score`] renders the result back into the capture and compares.
//!
